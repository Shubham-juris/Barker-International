...
export default function AboutHero({
  ...
  description =
    "Barker International is a professional trucking and logistics company offering dependable freight solutions for businesses of all sizes. We handle long-haul transport, dedicated trucking routes, LTL/FTL shipments, and full logistics support to keep your supply chain moving efficiently.",
  heroImage = main,
}) {
  return (
